...
export default class MongoData {
    ...
    isDirty(type=null) {
        const lastCheckpoint = this.lastCheckpoint(type, null, true);
    ...
    difference(type=null, previous) {
        if (isNullOrUndefined(previous)) previous = this.lastCheckpoint(type, null, true) || {data: {}};
    ...
    lastCheckpointIndex(type=null, start, includeCurrent=false) {
    ...
    lastCheckpoint(type=null, start, includeCurrent=false) {
        const index = this.lastCheckpointIndex(type, start, includeCurrent);
